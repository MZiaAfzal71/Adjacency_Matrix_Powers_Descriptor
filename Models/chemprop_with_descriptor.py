...
out_dir = Path("chemprop_model/ch_pt_wl_random") # directory for storing the best model after training
...
# desc_path = 'Excel Files/MACCSDescriptor.xlsx'  # path of extra molecule descriptors
desc_path = 'Excel Files/wl_featuresGrakel.csv'  # path of extra molecule descriptors
...
mpnn = models.MPNN(mp, agg, ffn, X_d_transform=X_d_transform, metrics=metric_list)
...
# Report performance
print(f'🧬 Processing descriptor: D-MPNN (chemprop + wl)')
print(f'📂 Using split: random')
...
new_results.to_excel('Output/DMPNN_chemprop_wl_random.xlsx', index=False)
